...
from Models.Util.misc import relative_matmul,generate_relative_positions_matrix


class MultiHeadedAttention(nn.Module):
    """Multi-Head Attention module from "Attention is All You Need":cite:`DBLP:journals/corr/VaswaniSPUJGKP17`.
    ...
    Args:
       head_count (int): number of parallel heads.多头数量
