...
def convert_MUCLSexamples_to_features(examples: List[MUCLS_Example],
    ...
    for i, example in enumerate(examples):
        ...
        features.append(feature)
        src_lengths.append(len(label_ids))
...
def create_TokenCLSexamples(args,
    ...
    if mode == 'train':
        dataset = read_TokenCLS_dataset(args.src_seq,args.src_mulabel)
    elif mode == 'test':
        dataset = read_TokenCLS_dataset(args.val_seq,args.val_mulabel)
